...
public class DBConnect {
	...
	private final String dbName = "LapTrinhWebVD2";
	...
	public Connection getConnection() throws SQLException {
		...
		if (instance == null || instance.trim().isEmpty()) {
			url = "jdbc:sqlserver://" + serverName + ":" + portNumber + ";databaseName=" + dbName + ";user=" + userID
			...
			url = "jdbc:sqlserver://" + serverName + "\\" + instance + ":" + portNumber + ";databaseName=" + dbName
					+ ";user=" + userID + ";password=" + password + ";encrypt=true;trustServerCertificate=true";
		}
